...
@author: INDERDEEP SINGH,HARGOVIND SINGH,IKBIR SINGH,CHANNPREET SINGH,HARSHDEEP (1800856,1800841,1800855,1800824,1899850)
"""
...
def fbtn1():
    ...
    def submit():
        ...
        def sendPostRequest(reqUrl, apiKey, secretKey, useType, phoneNo, senderId, textMessage):
            req_params = {
                'apikey':'DC9FLLBVK0WZ8CEKQ0RMVYNJSC0Y9S8H',
                'secret':'1E07GI94Y6IJCYJR',
                'usetype':'stage',
                'phone': mbn.get(),
                'message':"Congrats Mr. " +""+name.get()+""+" you are Registered Successfully on BBSBEC Database.",
                'senderid':'11'
            }
        ...
        print (response.text)   #only 3 remaining
